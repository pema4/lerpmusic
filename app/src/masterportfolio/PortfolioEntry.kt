...
enum class PortfolioEntry(
    ...
    FIRST_COURSE(
        ...
        Paragraph(
            """
                Также на основе этого синтезатора я сделали другой проект.
                Это монофонический синтезатор с фильтром, параметрами которого можно управлять
                с помощью самописного языка программирования: а именно, произвольным способом
                модулировать высоту тона, громкость, частоту среза фильтра и его резонанс.
                По умолчанию синтезатор играет только тон 440 герц независимо от того,
                какая клавиша нажата, но с помощью кода можно заставить его играть хроматически,
                задать огибающие, LFO громкости и фильтра, сделать арпеджио, портаменто.
            """.trimIndent()
        ),
        YoutubeVideo.PROGRAMMABLE_SYNTH,
    ),
